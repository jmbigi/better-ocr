...
- **docbee (PP-DocBee-2B) en la batería 360°: PENDIENTE** — requiere equipo con GPU; el harness (`scripts/bateria_360.py --motor docbee`) está listo, falta ejecutarlo y comparar contra gemma/qwen.
